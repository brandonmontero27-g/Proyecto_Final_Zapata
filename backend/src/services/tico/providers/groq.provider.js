import { ticoTools } from '../tools.js';
...
// Las TicoTool.parameters se escriben en el formato de Gemini (Type.OBJECT,
...
// Adaptador Groq: misma interfaz publica que TicoService (Gemini), para que
// el controller pueda intercambiar de proveedor sin tocar la logica de negocio.
export class GroqTicoService {
  constructor(apiKey, tools = ticoTools) {
    this.apiKey = apiKey;
    this.tools = tools;
  }
